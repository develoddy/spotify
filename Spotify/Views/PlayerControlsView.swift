...
protocol PlayerControlsViewDelegate: AnyObject {
    ...
    func playerControlsView(_ playerControlsView: PlayerControlsView, didSlidelider value: Float)
}
...
final class PlayerControlsView: UIView {
    ...
    private let subtitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Romeo Santos (feat. Don Omar Artist)"
        label.numberOfLines = 1
    ...
    @objc func didSlideSlider(_ slider: UISlider) {
        ...
        delegate?.playerControlsView(self, didSlidelider: value)
    }
    ...
    func confiure(with viewModel: PlayerControlsViewViewModel) {
