...
class FeaturedPlaylistCollectionViewCell: UICollectionViewCell {
    ...
    private let playlistsNameLabel: UILabel = {
        let label = UILabel()
    ...
    override init(frame: CGRect) {
        ...
        contentView.addSubview(playlistsNameLabel)
    ...
    override func layoutSubviews() {
        ...
        playlistsNameLabel.frame = CGRect(
            x: 3,
